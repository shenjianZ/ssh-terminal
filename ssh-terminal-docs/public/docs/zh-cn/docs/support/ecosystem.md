...
**重要说明**：所有官方项目都托管在同一个 GitHub 仓库中：
- **仓库地址**：https://github.com/shenjianZ/ssh-terminal

```
SSH Terminal 生态系统（单仓库）
├── ssh-terminal/          # 桌面客户端（根目录）
...
**位置**：`ssh-terminal-web/` 目录

**描述**：SSH Terminal 的 Web端，提供web端的 SSH 会话管理功能。
